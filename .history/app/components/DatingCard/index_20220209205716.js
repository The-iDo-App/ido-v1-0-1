...
export default function DatingCard(props) {
  ...
  var musicItems = interests.hobbies ;
  var filmItems = interests.hobbies;
  var petItems = interests.hobbies; 
  var bookItems = interests.hobbies; 
  var foodItems = interests.hobbies; 
