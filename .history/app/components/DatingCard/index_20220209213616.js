        ...
        >
               ...
               <View style={style.modalBody} >
                  ...
                  <ScrollView scrollEnabled  contentContainerStyle={{ display: 'flex', flexGrow: 1 }} >
                      <View>
                       {/*ABOUT ME*/}
                       <Text style={{color: COLORS.grey, fontSize: 18, fontWeight: '700'}}  >What about me</Text>
                     ...
                     <View>
                       ...
                       {/*SPORTS*/}
                       <Text style={{color: COLORS.grey, fontSize: 18, fontWeight: '800'}}  >I am interested in...</Text>
                        <View>
