...
export default function DatingCard(props) {
  ...
  const {nickname, age, distance, matchRate, image, bio, city, interests, about} = props.user;
                  ...
                  <ScrollView scrollEnabled  contentContainerStyle={{ display: 'flex', flexGrow: 1 }} >
                      <View>
                       ...
                       <Text style={{color: COLORS.grey, fontSize: 16, fontWeight: '700'}}  >What about me</Text>
                        ...
                        {/*Political Stand*/}
                        <ChipAbout label="Political Stand" text={signItem} />
                        {/*Religion*/}
                        <ChipAbout label="Religion" text={signItem} />
                        {/*Do I smoke?*/}
                        <ChipAbout label="Do I smoke?" text={signItem} />
                        {/*SIGN*/}
                        <ChipAbout label="Do I drink?" text={signItem} />
                        {/*SIGN*/}
                        <ChipAbout label="Do I want to have kids?" text={signItem} />
