                      ...
                      <View>
                       ...
                       <Text style={{color: COLORS.grey, fontSize: 16, fontWeight: '700'}}  >What about me</Text>
                        ...
                        <View style={{display: 'flex', flexDirection: 'row', alignItems: 'center'}} >
                          <Text style={chipStyle.itemLabel}> Astrological Sign : </Text>
                          <View style={{backgroundColor: COLORS.lightPink, paddingHorizontal: 10, paddingVertical: 5, borderRadius: 10}}  >
                              <Text style={{color: COLORS.white}}  >{signItem}</Text>
                          </View>
