...
import { View, Text, Dimensions, StyleSheet, ImageBackground, Modal, Platform, FlatList, Pressable} from 'react-native';
               ...
               <View style={style.modalBody} >
                  <View>
                    <View  style={style.imageWrapper}>
                      <TouchableOpacity onPress={()=>setModalVisible(true)} >
                            <Image source={card} resizeMode="contain" style={style.image}  />
                  </View>
                  </View>
               </View>
        </Modal>
