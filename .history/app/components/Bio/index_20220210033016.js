  ...
  return (
    <>  
            <View style={{marginHorizontal: 20, marginTop: 10 }}  >
                    ...
                    <View style={{margin: 10, borderColor: COLORS.grey, borderWidth: 0.5, borderStyle: 'solid', borderRadius: 20, padding: 20}} >
                        <Text style={{fontSize: 18, color: COLORS.grey}} >{bioText}</Text>
                    </View>
            </View>
