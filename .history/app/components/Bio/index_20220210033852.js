    ...
    <>  
            <View style={{paddingHorizontal: 20, marginTop: 10, flex: 1, justifyContent: 'center' }}  >
                ...
                <View style={{alignItems: 'center',  justifyContent: 'center', flex: 1}}  >
                    ...
                    <View style={{ borderColor: COLORS.grey, borderWidth: 0.5, borderStyle: 'solid', borderRadius: 10, flex: 1, paddingHorizontal: 10, margin: 5, paddingVertical: 20, height: width/3, }} >
