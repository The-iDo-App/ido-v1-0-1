...
export default function BioComponent() {
  ...
  return (
    <>  
            <View style={{paddingHorizontal: 20, marginTop: 10, flex: 1, justifyContent: 'ce' }}  >
                    ...
                    <View style={{ borderColor: COLORS.grey, borderWidth: 0.5, borderStyle: 'solid', borderRadius: 20, paddingHorizontal: 20}} >
