            ...
            <View style={{paddingHorizontal: 20, marginTop: 10, flex: 1, justifyContent: 'center' }}  >
                    <View style={{flex: 1, flexDirection: 'row', alignItems: 'center',  justifyContent: 'center' }}  >
                        ...
                        <TouchableOpacity onPress={() => setBioEditModal(true)} >
                            <FontAwesome name='edit' size={30}  style={{marginLeft: 10, color: COLORS.grey}} />
                        </TouchableOpacity>
                    </View>
                    <View style={{ borderColor: COLORS.grey, borderWidth: 0.5, borderStyle: 'solid', borderRadius: 20, flex: 1}} >
