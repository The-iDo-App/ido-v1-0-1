...
export default function DeleteAccountModal({onPress, modalVisible, handleDeleteAccount, openSmallModal, closeSmallModal, confirmModal, isClose, handleReason({key, reasoning}})}) {
