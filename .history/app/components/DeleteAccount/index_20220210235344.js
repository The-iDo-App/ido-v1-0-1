...
export default function DeleteAccountModal({ reasoningState ,onPress, modalVisible, handleDeleteAccount, openSmallModal, closeSmallModal, confirmModal, isClose}) {
