...
export default function DeleteAccountModal({onPress, modalVisible, handleDeleteAccount, openSmallModal, closeSmallModal, confirmModal, selectReason, handleReason }) {
