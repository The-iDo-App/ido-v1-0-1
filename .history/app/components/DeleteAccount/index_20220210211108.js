...
export default function DeleteAccountModal({onPress, modalVisible}) {
    ...
    const [selectReason, setSelectReason] = React.useState(null);
                                ...
                                REASONS.map((reason, index) => {
                                    ...
                                    return(
                                        <React.Fragment key={reason.key} >
                                            <Item item={reason.orientation} borderColor={borderColor} backgroundColor={backgroundColor} color={color} />
                                        </React.Fragment>
                                    )
                                })
                            }
