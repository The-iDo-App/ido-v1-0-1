         ...
         <Modal
          ...
          >
                        ...
                        <View style={style.modalBody} >
                            ...
                            data={REASONS}
                            renderItem={({item}) => {
                                const backgroundColor = item.key === reasoning ? COLORS.darkPink : COLORS.white;
                                const borderColor = item.key ===  reasoning  ? COLORS.darkPink : COLORS.grey;  
                                const color = item.key ===  reasoning  ? COLORS.white : COLORS.grey;      
                                return (
                                    <Item
                                        item={item}
