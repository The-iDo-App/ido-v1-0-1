...
export default function DeleteAccountModal({ stringReasonState ,reasoningState ,onPress, modalVisible, handleDeleteAccount, openSmallModal, closeSmallModal, confirmModal, isClose}) {

    // const [selectReason, setSelectReason] = React.useState(reasoningState);
    // const [reasoning, setReasoning] = React.useState(stringReasonState);
