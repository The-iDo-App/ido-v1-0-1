         ...
         <Modal
          ...
          >
                        ...
                        <View style={style.modalFooter} >
                             <Pressable style={style.saveBtn} onPress={() => setConfirmModal(true)} >
            ...
            <View style={smallStyle.anotherView}>
                <View style={smallStyle.modalView} >
                    ...
                    <View style={smallStyle.modalBody} >
                            ...
                            <View>
                                <TextInput style={{borderColor: COLORS.grey, borderWidth: 1, padding: 16, borderRadius: 10, marginTop: 10}} />
                            </View>
                    </View>
...
const smallStyle = StyleSheet.create({
  ...
  inputTextStyle: {borderColor: COLORS.grey, borderWidth: 1, padding: 16, borderRadius: 10, marginTop: 10}
})