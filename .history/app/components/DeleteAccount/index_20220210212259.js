...
const Item =({item, onPress, backgroundColor, borderColor, color}) => {
    return(
    <Pressable style={[Register.chips, backgroundColor, borderColor]} onPress={onPress}>
            <View >
         ...
         <Modal
          ...
          >
                        ...
                        <View style={style.modalBody} >
                            {
                                REASONS.map((reason) => {
                                    const backgroundColor = reason.dahilan === selectReason ? COLORS.darkPink : COLORS.white;
