...
export default function Profile() {
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: COLORS.white}}  >
      <HeaderWrapper />
      <ScrollView >
       <View style={{display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', width: '100%', marginHorizontal: 10}} >
          <View style={{display: 'flex', flexDirection: 'column', alignItems: 'flex-start', marginHorizontal: 5}}  >
               <UploadProfile />
          </View>
