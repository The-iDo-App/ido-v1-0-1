...
export default function Home() {
  ...
  return (
    < >
          ...
          if(i < currentIndex){
            ...
            return(
              <Animated.View key={i} style={[styles.animatedCard, rotateAndTranslate]}  {...panResponder.panHandlers} >
                ...
                <DatingCard  user={item} onPress={() => setUserInfoModalVisible(true)} />
             </Animated.View>
            );
          }
          else{
      ...
      {
        FakeUsers.map((item, i) => (
          <UserInfoModal nickname={item.nickname} modalVisible={userInfoModalVisible} onPress={() => setUserInfoModalVisible(false)} />
        ))
      }
