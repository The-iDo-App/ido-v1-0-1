  ...
  return (
    <>
     <HeaderWrapper />
      ...
      <DeleteAccountModal  modalVisible={open}  openSmallModal={() => setOpenModal(true)} closeSmallModal={() => setOpenModal(false)}   onPress={() => setOpen(false)} handleDeleteAccount={handleDeleteAccount}  />
    </>
