  ...
  return (
    <>
     <HeaderWrapper />
      ...
      <DeleteAccountModal  
        modalVisible={open} 
        confirmModal={openSmallModal} openSmallModal={() => setOpenModal(true)}  closeSmallModal={() => setOpenModal(false)}   onPress={closeModal} handleDeleteAccount={handleDeleteAccount}  />
    </>
