  ...
  return (
    <>
     <HeaderWrapper />
      ...
      <DeleteAccountModal  modalVisible={open} openSmallModal={() => setOpenModal(true)} openSmallModal={() => setOpenModal(true)}   onPress={() => setOpen(false)} handleDeleteAccount={handleDeleteAccount}  />
    </>
