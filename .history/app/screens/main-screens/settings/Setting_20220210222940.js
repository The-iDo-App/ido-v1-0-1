  ...
  return (
    <>
     <HeaderWrapper />
      ...
      <DeleteAccountModal  modalVisible={open} openSmallModal={() => setOpenModal(true)} closeSmallModal={() => setOpenModal(true)}   onPress={() => setOpen(false)} handleDeleteAccount={handleDeleteAccount}  />
    </>
