  ...
  return (
    <>
     <HeaderWrapper />
      ...
      <DeleteAccountModal  modalVisible={open} confirmModal={openSmallModal} openSmallModal={() => setOpenModal(true)} reasoningState= closeSmallModal={() => setOpenModal(false)}   onPress={() => setOpen({...initialState, open: false})} handleDeleteAccount={handleDeleteAccount}  />
    </>
