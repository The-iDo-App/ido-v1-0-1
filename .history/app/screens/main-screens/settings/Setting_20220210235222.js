...
export default function Settings({navigation}) {
  ...
  const initialState = {selectReason: " "}
  ...
  return (
    <>
     <HeaderWrapper />
      ...
      <DeleteAccountModal  modalVisible={open} confirmModal={openSmallModal} openSmallModal={() => setOpenModal(true)} reasoningState={initialState} closeSmallModal={() => setOpenModal(false)}   onPress={() => setOpen({...initialState, open: false})} handleDeleteAccount={handleDeleteAccount}  />
    </>
