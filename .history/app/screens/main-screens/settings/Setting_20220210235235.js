  ...
  return (
    <>
     <HeaderWrapper />
      ...
      <DeleteAccountModal  modalVisible={open} confirmModal={openSmallModal} openSmallModal={() => setOpenModal(true)}  closeSmallModal={() => setOpenModal(false)}   onPress={() => setOpen({...initialState, open: false})} handleDeleteAccount={handleDeleteAccount}  />
    </>
