...
export default function Settings({navigation}) {
  ...
  const reasonState = null;
  const stringReasonState = "";
  ...
  return (
    <>
     <HeaderWrapper />
      ...
      <DeleteAccountModal  modalVisible={open} reasoningState={reasonState} stringReasonState={stringReasonState} confirmModal={openSmallModal} openSmallModal={() => setOpenModal(true)}  closeSmallModal={() => setOpenModal(false)}   onPress={closeModal} handleDeleteAccount={handleDeleteAccount}  />
    </>
