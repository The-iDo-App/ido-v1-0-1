  ...
  return (
    <>
     <HeaderWrapper />
      ...
      <DeleteAccountModal  modalVisible={open} reasoningState=rea confirmModal={openSmallModal} openSmallModal={() => setOpenModal(true)}  closeSmallModal={() => setOpenModal(false)}   onPress={closeModal} handleDeleteAccount={handleDeleteAccount}  />
    </>
