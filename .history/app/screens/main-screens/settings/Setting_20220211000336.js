  ...
  return (
    <>
     <HeaderWrapper />
      ...
      <DeleteAccountModal  modalVisible={open} reasoningState= confirmModal={openSmallModal} openSmallModal={() => setOpenModal(true)}  closeSmallModal={() => setOpenModal(false)}   onPress={closeModal} handleDeleteAccount={handleDeleteAccount}  />
    </>
