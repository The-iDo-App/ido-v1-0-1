...
import Settings from '../screens/main-screens/settings/Setting';
import AboutScreen from '../screens/main-screens/settings/AboutScreen';
import BlockedUsersScreen from '../screens/main-screens/settings/BlockedUsers';
import GuidelinesScreen from '../screens/main-screens/settings/Guidelines';
...
const MessageTab = () => {
    return(
        <Stack.Navigator screenOptions={{ headerShown: false }}>
             <Stack.Screen name="MessageInbox" options={{header: () => null}}  component={MessageInbox} />
...
const SettingTab = () => {
    return(
         <Stack.Navigator screenOptions={{ headerShown: false }}   >
             <Stack.Screen name={tabName} options={{header: () => null}}  component={Settings} />
            ...
            <NavigationContainer>
                {loginState.userToken === null ?(
                    <Stack.Navigator screenOptions={{headerShown: false}} >
                        ...
                        <Stack.Screen name="SettingTab" options={{header: () => null}} component={SettingTab} />
                        <Stack.Screen name="MEssnboarding" options={{header: () => null}} component={Onboarding} />
                    </Stack.Navigator>
                ):(
                    <Stack.Navigator screenOptions={{headerShown: false}} >
