...
export default function BioComponent({ bio }) {
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          >
            ...
            <View
              style={{ height: 1, backgroundColor: COLORS.grey, flex: 1 }}
            />
      ...
      <Modal animationType="fade" visible={bioEditModal} transparent={true}>
