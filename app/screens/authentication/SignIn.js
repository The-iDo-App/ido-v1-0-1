...
export default function SignInPage({ navigation }) {
  ...
  const handleLogIn = async () => {
    ...
    try {
      user = await axios.post(`${BACKEND_BASEURL}/api/logins`, {
        email,
        password,
      });
    } catch (err) {
    ...
    if (user && user.data.access_token) {
      ...
      signIn(user.data.username, user.data.access_token);
    } else {
        ...
        <View>
          ...
          <View style={AuthenticationStyle.forgotWrap}>
            <TouchableOpacity onPress={() => navigation.navigate("ForgotPass")}>
              <Text style={AuthenticationStyle.forgotText}>
                Forgot password?
              </Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={AuthenticationStyle.orWrap}>
            ...
            <Text style={AuthenticationStyle.orText}>
              &nbsp;OR LOG IN WITH&nbsp;
            </Text>
          ...
          <View style={AuthenticationStyle.noAccountWrap}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate("SignUp")}>
              <Text style={AuthenticationStyle.noAccountLink}>
                Create an account!
              </Text>
            </TouchableOpacity>
          </View>
